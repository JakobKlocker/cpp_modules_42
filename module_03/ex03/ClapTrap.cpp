...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (this->hitPoints < 0)
		this->hitPoints = 0;
	std::cout << "ClapTrap " << this->name << " took " << amount << " points of damage! " << this->name << " has " << this->hitPoints << " left" << std::endl;
	;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	this->energyPoints--;
	this->hitPoints += amount;
	std::cout << "ClapTrap " << this->name << " repaired " << amount << " points of health! " << this->name << " has " << this->hitPoints << " healthpoints now" << std::endl;
}
